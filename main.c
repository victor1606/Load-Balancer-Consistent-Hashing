...
/*
 * Functia obtine perechea cheie-valoare din string-ul "request"
 */
...
/*
 * Functia obtine cheia din string-ul "request"
 */
...
/*
 * Functia citeste request-urile si apeleaza celelalte functii necesare
